...
`sudo ss -tulpn` чем заняты порты (все)

*`sudo lsof -i :8080`* посмотреть чем занят указанный порт **

`sudo lsof -i` тоже порты
...
[https://github.com/cyberspacedk/VScode-hotkeys](https://github.com/cyberspacedk/VScode-hotkeys)
